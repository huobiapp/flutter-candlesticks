...
abstract class KlinePageDataSource {
  List<KlineData> klineDataList();
}

class KlinePage extends StatefulWidget {
  KlinePage({Key key,@required this.data}) : super(key: key);
  // KlinePageDataSource dataSource;
  List<KlineData> data;

  @override
  _KlinePageState createState() => _KlinePageState(data: data);
}

class _KlinePageState extends State<KlinePage>
    with SingleTickerProviderStateMixin {

  _KlinePageState({Key key,this.data});
  // KlinePageDataSource dataSource;
  List<KlineData> data;
